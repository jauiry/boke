...
export default function Hero({ onExplore }: HeroProps) {
  return (
    <section className="ink-hero relative min-h-[100dvh] overflow-hidden pt-20" aria-labelledby="hero-title">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100dvh-5rem)] max-w-7xl items-center px-5 pb-20 sm:px-8 lg:px-12">
        <div className="max-w-3xl pt-4 md:pt-0">
          ...
          <motion.h1
            ...
            className="font-serif-cn text-[clamp(3.5rem,9vw,6rem)] font-semibold leading-[0.92] tracking-[0.04em] text-ink"
          >
            见字
